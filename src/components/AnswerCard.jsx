...
const AnswerCard = ({ answer, color, myFunc }) => {
  ...
  const cardClassName = `block p-6 ${color} border rounded-lg w-full pt-10 pb-10 text-xl shadow hover:${color}-800 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700`;
  return (
    <div onClick={() => myFunc()}>
